...
import type { TestSubject, TestGrade } from '../types';
import { HomeIcon, ChevronRightIcon } from './icons';

interface TestGradeSelectionViewProps {
    subject: TestSubject;
    grades: TestGrade[];
...
const TestGradeSelectionView: React.FC<TestGradeSelectionViewProps> = ({ 
    subject, 
    grades, 
    onSelectGrade, 
    onBackToSubjects, 
...
export default TestGradeSelectionView;