...
interface TestSubjectSelectionViewProps {
  moduleTitle: string;
            ...
            <div className="flex-grow sm:ml-6">
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <p className="text-slate-500 text-sm mt-1 line-clamp-2">{subject.description || "Bài kiểm tra trắc nghiệm và tự luận."}</p>
                    </div>
                </div>
...
const TestSubjectSelectionView: React.FC<TestSubjectSelectionViewProps> = ({ moduleTitle, subjects, onSelectSubject, onBack }) => {
  return (
    <div className="container mx-auto max-w-4xl">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-slate-500 text-lg">
           Chọn môn học để làm bài kiểm tra 15 phút, 1 tiết hoặc học kỳ.
        </p>
      </div>
...
export default TestSubjectSelectionView;
