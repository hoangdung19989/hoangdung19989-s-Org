...
import type { MockExamSubject } from '../types';
import { HomeIcon, ChevronRightIcon } from './icons';

interface MockExamSubjectSelectionViewProps {
  moduleTitle: string;
...
const MockExamSubjectCard: React.FC<{
...
const MockExamSubjectSelectionView: React.FC<MockExamSubjectSelectionViewProps> = ({ moduleTitle, subjects, onSelectSubject, onBack }) => {
  return (
    <div className="container mx-auto max-w-4xl">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-slate-500 text-lg">
          Chọn môn thi để trải nghiệm làm bài thi thử với cấu trúc chuẩn và áp lực thời gian thực.
        </p>
      </div>
...
export default MockExamSubjectSelectionView;